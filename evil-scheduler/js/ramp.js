...
var ProposersView = React.createClass({
    ...
    renderValueTr: function renderValueTr(proposer) {
...
var CommittedView = React.createClass({
    ...
    renderValueTr: function renderValueTr(committed) {
        return React.createElement(
            "tr",
            null,
            React.createElement(
...
var ValuesView = React.createClass({
    ...
    renderValueTr: function renderValueTr(row) {
        if (row.key == null) {
            return React.createElement(
                "tr",
                null,
...
},{"../stepbystep/view":13,"../yabandeh/ThreadView":14,"./RAMPModel":6,"./SideView":7}],6:[function(require,module,exports){
"use strict";
...
var __confirm = Fun(hl2("function confirm(values) {"), Seq([Skip(function (ctx) {
    ...
    var unfinished = [];
    var is_used = {};
    var add = function add(shard, txid) {
...
},{"../stepbystep/dsl":8,"../stepbystep/model":9,"../stepbystep/monokai":10,"../stepbystep/view":13,"./DB":2,"./KeyTable":4}],7:[function(require,module,exports){
"use strict";
...
},{"../stepbystep/model":9,"../stepbystep/sideview/StackView":11,"../stepbystep/view":13,"./DBView":3}],8:[function(require,module,exports){
"use strict";
...
},{"./monokai":10}],9:[function(require,module,exports){
"use strict";
...
},{"../stepbystep/view":13}],11:[function(require,module,exports){
"use strict";
...
},{"../view":13,"./obj_to_table":12}],12:[function(require,module,exports){
"use strict";
...
},{"../model":9}],13:[function(require,module,exports){
"use strict";
